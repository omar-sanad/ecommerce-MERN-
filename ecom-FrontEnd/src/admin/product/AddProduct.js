            ...
            >
                ...
                <div className="row">
                    <div className="col-md-6 mx-auto">
                        <form onSubmit={submitProduct} className={`pt-5 px-5 pb-2 mt-3 ${styles.formStyle}`}>
                        <div className='text-center display-4'>Add New Product</div>
                        <div className="form-group mt-5">
                            ...
                            <div className="form-group">
                                ...
                                <input value={product.name} onChange={handleChange} id="name" required autoFocus placeholder="Product Name" type="text" className="form-control"/>
                            </div>
                            ...
                            <label htmlFor="shipping">shipping</label>
                                <select className="form-control" value={product.shipping} onChange={handleChange} name="shipping" id="shipping" >
                            ...
                            <button className={`my-5 btn-block btn ${styles.bgButton} py-3`}>Create New Product</button>
                        </form>
